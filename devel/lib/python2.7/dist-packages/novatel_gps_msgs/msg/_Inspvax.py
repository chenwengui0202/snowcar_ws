...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_H().pack(self.seconds_since_update))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.ins_status = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.extended_status.psuedorange_iono_correction = str[start:end].decode('utf-8')
      else:
