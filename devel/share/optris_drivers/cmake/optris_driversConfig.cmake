...
if("TRUE" STREQUAL "TRUE")
  set(optris_drivers_SOURCE_PREFIX /home/nvidia/snowcar_ws/src/optris_drivers)
  set(optris_drivers_DEVEL_PREFIX /home/nvidia/snowcar_ws/devel)
  ...
  set(optris_drivers_INSTALL_PREFIX /home/nvidia/snowcar_ws/install)
...
if(NOT "/home/nvidia/snowcar_ws/devel/include;/usr/include " STREQUAL " ")
  set(optris_drivers_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/snowcar_ws/devel/include;/usr/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/optris_drivers " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/optris_drivers' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Stefan May(Nuremberg Institute of Technology Georg Simon Ohm - www.th-nuernberg.de) <stefan.may@th-nuernberg.de>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'optris_drivers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'optris_drivers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/snowcar_ws/src/optris_drivers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/snowcar_ws/devel/lib;/home/nvidia/snowcar_ws/devel/lib;/opt/ros/kinetic/lib)
